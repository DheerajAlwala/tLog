...
import 'package:tlog/services/function/comments.dart';
import 'package:tlog/services/function/like.dart';
import 'package:tlog/services/function/save.dart';
...
class BlogViewTile extends StatefulWidget {
  String imgUrl, title, description, authorname, time, documentId,duration,alongwith,country;
      ...
      child: Card(
        child: Column(
          children: <Widget>[
            ...
            SizedBox(height:30,child: Text("Duration of Trip: "+widget.duration,style: TextStyle(color:Colors.indigo,fontWeight: FontWeight.bold,),)),
            SizedBox(height:30,child: Text("Destination country : "+widget.country,style: TextStyle(color:Colors.black87,fontWeight: FontWeight.bold,),)),
            SizedBox(height:30,child: Text("Along with: "+widget.alongwith,style: TextStyle(color:Colors.deepPurple,fontWeight: FontWeight.bold,),)),
